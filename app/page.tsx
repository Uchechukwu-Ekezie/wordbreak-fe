...
type View = "landing" | "home" | "records" | "profile" | "settings" | "map" | "loading" | "playing" | "result";
      ...
      <main className="shell gate">
        ...
        <div className="gate-inner">
          ...
          <button className="btn ghost gate-btn" style={{ marginTop: 10 }} onClick={doConnect} disabled={connecting}>
            {connecting ? "Connecting…" : account ? `⚡ ${shortAcct}` : hasWallet() ? "⚡ Connect wallet" : "⚡ Open in MiniPay"}
          </button>
